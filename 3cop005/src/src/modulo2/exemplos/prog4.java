 ...
 * @author ADANIYA
 */
public class prog4 implements GLEventListener{
public static void main(String[] args) {
        Frame frame = new Frame("Exercicio 02 - Dinossauro");
        GLCanvas canvas = new GLCanvas();

        canvas.addGLEventListener(new prog4());
        frame.add(canvas);
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        desenharDinossauro("dino.dat", drawable);
    ...
    public void desenharDinossauro(String nomeArquivo, GLAutoDrawable drawable){
        GL gl =  drawable.getGL();
